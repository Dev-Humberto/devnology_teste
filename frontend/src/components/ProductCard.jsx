...
const ProductCard = (props) => {
    let { gallery, price, name, id} = props.data;
    ...
    return (
        ...
        >
            <Link to={`/product-details/${id}`}>
                <div style={{ background: 'white', height: '12rem', overflow: 'hidden', display: 'flex',
                justifyContent: 'center', alignItems: 'center', marginBottom: 'inherit' }}>
                    <div style={{ width: '18rem'}}>
                        <Card.Img variant="top" src={gallery[0]} className="img-fluid" />
                    </div>
                </div>
            </Link>
            <Card.Body>
